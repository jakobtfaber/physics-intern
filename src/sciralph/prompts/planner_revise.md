...
- The current state of all research entities (one-liners)
...
2. For each active entity (ER, WH, RQ), whether it should be kept, abandoned, or re-reviewed
...
- `keep` — entity remains valid under the revised strategy
- `abandon` — entity is based on premises that the revision invalidates
- `re-review` — entity may be correct but was evaluated under the wrong framework; needs fresh review

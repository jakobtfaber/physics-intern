...
class OrchestratorToolExecutor:
    ...
    def _build_guidance(
        ...
        from sciralph.research_state import HypothesisStatus, Verdict
        guidance: list[str] = []
    ...
    def _add_hypothesis(self, args: dict) -> str:
        from sciralph.research_state import CritiqueStatus, Hypothesis, HypothesisStatus, RQStatus, Severity
    ...
    def _abandon_hypothesis(self, args: dict) -> str:
        from sciralph.research_state import FailedApproach, HypothesisStatus
    ...
    def _add_research_question(self, args: dict) -> str:
        from sciralph.research_state import CritiqueStatus, ResearchQuestion, Severity
    ...
    def _abandon_research_question(self, args: dict) -> str:
        from sciralph.research_state import RQStatus
    ...
    def _check_focus(self, target: str) -> str | None:
        ...
        Returns error string or None if valid.
        """
        from sciralph.research_state import Verdict

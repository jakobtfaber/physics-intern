...
class OrchestratorAgent(BaseAgent):
    ...
    def _critique_handling_banner() -> str:
        return (
            "\n>>> HANDLING CRITIQUES <<<\n"
            "A HIGH critique is a top-priority research signal — it points where the answer "
            "might change. The critic does NOT see detailed evidence or code; a reviewer's "
            "VERIFIED verdict is stronger on specific claims.\n"
            "\n"
            ...
            "critique is already addressed or immaterial. Prefer investigation over dismissal "

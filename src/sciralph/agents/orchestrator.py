...
class OrchestratorAgent(BaseAgent):
    ...
    def _critique_handling_banner() -> str:
        return (
            ...
            "- **Investigate (preferred)** — Dispatch a research or compute task targeting the "
            "entity the critique is about (e.g., target_claim='ER-001'). The dispatched agent "
            "will see both the entity and the active critique in its context. You may also "
            "dispatch with target_claim set to the critique ID (e.g., CRIT-001) — the system "
            "will auto-redirect to the critique's target entity. After evidence comes back in "
            "the EVIDENCE RESULTS banner, resolve the critique citing the new evidence.\n"

...
Uses the provider layer (physics_intern.providers + physics_intern.core.config) and the
shared baseline helpers (physics_intern.baselines) for the initial generation,
...
Usage:
    ...
    uv run python -m physics_intern.rsa problems/critpt/quantum_error_correction_main.yaml --model gpt-5.4-high
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="physics_intern.rsa",
        description="RSA (Recursive Self-Aggregation) runner for PhysicsIntern problems.",
    )

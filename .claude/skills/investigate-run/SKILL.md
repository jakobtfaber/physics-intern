...
### Step 2: Investigate
   ...
   - If an issue raised lacks sufficient explanations to understand what went wrong and what could be fixed, trace it back through the workspace files to find the root cause and make it explicit.

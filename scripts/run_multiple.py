...
Usage:
    uv run python scripts/run_multiple.py problems/critpt/yaml/Challenge_1_main.yaml --runs 10
    uv run python scripts/run_multiple.py problems/critpt/yaml/Challenge_1_main.yaml --runs 10 --concurrency 3
    uv run python scripts/run_multiple.py problems/critpt/yaml/Challenge_1_main.yaml --runs 20 --concurrency 5 --model claude-4.6-opus --max-iterations 30
"""
